...
from . import webdriver_factory
from .a11y import PyleniumAxe
from .cdp import CDP
from .config import PyleniumConfig
from .element import Element, Elements
from .log import logger as log
from .performance import Performance
from .switch_to import SwitchTo
from .wait import PyleniumWait
...
class Pylenium:
    ...
    def go(self, direction: str, number: int = 1) -> "Pylenium":
        ...
        Returns:
            The current instance of Pylenium
        """
        with allure.step(f'Go {direction} {number} times'):
